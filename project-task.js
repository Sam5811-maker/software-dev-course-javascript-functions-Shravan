...
console.log("The Sum of " + num1 + " & " + num2 + " is = " + sumCalculation(num1, num2));

// Script 3 - Product calculation
function productCalculation(num1, num2) {
   return num1 * num2;
}
console.log("The Product of " + num1 + " & " + num2 + "is = " + sumCalculation(num1, num2));
